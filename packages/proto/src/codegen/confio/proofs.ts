...
export const ExistenceProof = {
  ...
  fromAmino(object: ExistenceProofAmino): ExistenceProof {
    return {
      key: object.key,
      value: object.value,
      leaf: object?.leaf ? LeafOp.fromAmino(object.leaf) : LeafOp.fromPartial({}),
...
export const NonExistenceProof = {
  ...
  fromAmino(object: NonExistenceProofAmino): NonExistenceProof {
    return {
      key: object.key,
      left: object?.left ? ExistenceProof.fromAmino(object.left) : ExistenceProof.fromPartial({}),
      right: object?.right ? ExistenceProof.fromAmino(object.right) : ExistenceProof.fromPartial({})
    };
  },
...
export const CommitmentProof = {
  ...
  fromAmino(object: CommitmentProofAmino): CommitmentProof {
    return {
      exist: object?.exist ? ExistenceProof.fromAmino(object.exist) : ExistenceProof.fromPartial({}),
      nonexist: object?.nonexist ? NonExistenceProof.fromAmino(object.nonexist) : NonExistenceProof.fromPartial({}),
      batch: object?.batch ? BatchProof.fromAmino(object.batch) : BatchProof.fromPartial({}),
      compressed: object?.compressed ? CompressedBatchProof.fromAmino(object.compressed) : CompressedBatchProof.fromPartial({})
    };
  },
...
export const ProofSpec = {
  ...
  fromAmino(object: ProofSpecAmino): ProofSpec {
    return {
      leafSpec: object?.leaf_spec ? LeafOp.fromAmino(object.leaf_spec) : LeafOp.fromPartial({}),
      innerSpec: object?.inner_spec ? InnerSpec.fromAmino(object.inner_spec) : InnerSpec.fromPartial({}),
...
export const CompressedBatchEntry = {
  ...
  fromAmino(object: CompressedBatchEntryAmino): CompressedBatchEntry {
    return {
      exist: object?.exist ? CompressedExistenceProof.fromAmino(object.exist) : CompressedExistenceProof.fromPartial({}),
      nonexist: object?.nonexist ? CompressedNonExistenceProof.fromAmino(object.nonexist) : CompressedNonExistenceProof.fromPartial({})
    };
  },
...
export const CompressedNonExistenceProof = {
  ...
  fromAmino(object: CompressedNonExistenceProofAmino): CompressedNonExistenceProof {
    return {
      key: object.key,
      left: object?.left ? CompressedExistenceProof.fromAmino(object.left) : CompressedExistenceProof.fromPartial({}),
      right: object?.right ? CompressedExistenceProof.fromAmino(object.right) : CompressedExistenceProof.fromPartial({})
    };
  },
