...
export const ContractState = {
  ...
  fromAmino(object: ContractStateAmino): ContractState {
    return {
      contractInfo: object?.contractInfo ? ContractInfoV2.fromAmino(object.contractInfo) : undefined,
...
export const ContractPairPrices = {
  ...
  fromAmino(object: ContractPairPricesAmino): ContractPairPrices {
    return {
      pricePair: object?.pricePair ? Pair.fromAmino(object.pricePair) : undefined,
