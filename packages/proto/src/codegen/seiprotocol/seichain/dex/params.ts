...
export const Params = {
  ...
  fromPartial(object: Partial<Params>): Params {
    const message = createBaseParams();
    message.priceSnapshotRetention = object.priceSnapshotRetention !== undefined && object.priceSnapshotRetention !== null ? BigInt(object.priceSnapshotRetention.toString()) : BigInt(0);
    message.sudoCallGasPrice = object.sudoCallGasPrice ?? "";
    message.beginBlockGasLimit = object.beginBlockGasLimit !== undefined && object.beginBlockGasLimit !== null ? BigInt(object.beginBlockGasLimit.toString()) : BigInt(0);
    ...
    message.defaultGasPerOrder = object.defaultGasPerOrder !== undefined && object.defaultGasPerOrder !== null ? BigInt(object.defaultGasPerOrder.toString()) : BigInt(0);
    message.defaultGasPerCancel = object.defaultGasPerCancel !== undefined && object.defaultGasPerCancel !== null ? BigInt(object.defaultGasPerCancel.toString()) : BigInt(0);
    ...
    message.gasAllowancePerSettlement = object.gasAllowancePerSettlement !== undefined && object.gasAllowancePerSettlement !== null ? BigInt(object.gasAllowancePerSettlement.toString()) : BigInt(0);
    message.minProcessableRent = object.minProcessableRent !== undefined && object.minProcessableRent !== null ? BigInt(object.minProcessableRent.toString()) : BigInt(0);
    message.orderBookEntriesPerLoad = object.orderBookEntriesPerLoad !== undefined && object.orderBookEntriesPerLoad !== null ? BigInt(object.orderBookEntriesPerLoad.toString()) : BigInt(0);
    message.contractUnsuspendCost = object.contractUnsuspendCost !== undefined && object.contractUnsuspendCost !== null ? BigInt(object.contractUnsuspendCost.toString()) : BigInt(0);
    ...
    message.maxPairsPerContract = object.maxPairsPerContract !== undefined && object.maxPairsPerContract !== null ? BigInt(object.maxPairsPerContract.toString()) : BigInt(0);
    message.defaultGasPerOrderDataByte = object.defaultGasPerOrderDataByte !== undefined && object.defaultGasPerOrderDataByte !== null ? BigInt(object.defaultGasPerOrderDataByte.toString()) : BigInt(0);
    return message;
  },
  fromAmino(object: ParamsAmino): Params {
    return {
      priceSnapshotRetention: BigInt(object.price_snapshot_retention),
      sudoCallGasPrice: object.sudo_call_gas_price,
      beginBlockGasLimit: BigInt(object.begin_block_gas_limit),
      endBlockGasLimit: BigInt(object.end_block_gas_limit),
      defaultGasPerOrder: BigInt(object.default_gas_per_order),
      defaultGasPerCancel: BigInt(object.default_gas_per_cancel),
      minRentDeposit: BigInt(object.min_rent_deposit),
      gasAllowancePerSettlement: BigInt(object.gas_allowance_per_settlement),
      minProcessableRent: BigInt(object.min_processable_rent),
      orderBookEntriesPerLoad: BigInt(object.order_book_entries_per_load),
      contractUnsuspendCost: BigInt(object.contract_unsuspend_cost),
      maxOrderPerPrice: BigInt(object.max_order_per_price),
      maxPairsPerContract: BigInt(object.max_pairs_per_contract),
      defaultGasPerOrderDataByte: BigInt(object.default_gas_per_order_data_byte)
    };
  },
