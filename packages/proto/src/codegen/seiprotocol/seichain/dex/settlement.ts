...
export const SettlementEntry = {
  ...
  fromAmino(object: SettlementEntryAmino): SettlementEntry {
    return {
      ...
      executionCostOrProceed: object.executionCostOrProceed,
      expectedCostOrProceed: object.expectedCostOrProceed,
      positionDirection: object.positionDirection,
      orderType: object.orderType,
      orderId: BigInt(object.orderId),
      timestamp: BigInt(object.timestamp),
      height: BigInt(object.height),
      settlementId: BigInt(object.settlementId)
    };
  },
...
export const Settlements = {
  ...
  fromAmino(object: SettlementsAmino): Settlements {
    return {
      ...
      entries: Array.isArray(object?.entries) ? object.entries.map((e: any) => SettlementEntry.fromAmino(e)) : []
    };
  },
