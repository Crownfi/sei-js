...
export const ScheduledTokenRelease = {
  ...
  fromAmino(object: ScheduledTokenReleaseAmino): ScheduledTokenRelease {
    return {
      startDate: object.start_date,
      endDate: object.end_date,
      tokenReleaseAmount: BigInt(object.token_release_amount)
    };
  },
...
export const Params = {
  ...
  fromAmino(object: ParamsAmino): Params {
    return {
      ...
      tokenReleaseSchedule: Array.isArray(object?.token_release_schedule) ? object.token_release_schedule.map((e: any) => ScheduledTokenRelease.fromAmino(e)) : []
    };
  },
...
export const Version2Minter = {
  ...
  fromAmino(object: Version2MinterAmino): Version2Minter {
    return {
      lastMintAmount: object.last_mint_amount,
      lastMintDate: object.last_mint_date,
      lastMintHeight: BigInt(object.last_mint_height),
      denom: object.denom
    };
...
export const Version2Params = {
  ...
  fromAmino(object: Version2ParamsAmino): Version2Params {
    return {
      mintDenom: object.mint_denom,
      tokenReleaseSchedule: Array.isArray(object?.token_release_schedule) ? object.token_release_schedule.map((e: any) => Version2ScheduledTokenRelease.fromAmino(e)) : []
    };
  },
