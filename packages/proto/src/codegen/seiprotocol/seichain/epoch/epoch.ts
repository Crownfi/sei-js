...
export const Epoch = {
  ...
  fromPartial(object: DeepPartial<Epoch>): Epoch {
    const message = createBaseEpoch();
    message.genesisTime = object.genesisTime ?? new Date(0);
    message.epochDuration = Duration.fromPartial(object.epochDuration ?? {});
    message.currentEpoch = object.currentEpoch !== undefined && object.currentEpoch !== null ? BigInt(object.currentEpoch.toString()) : BigInt(0);
    message.currentEpochStartTime = object.currentEpochStartTime ?? new Date(0);
  ...
  fromAmino(object: EpochAmino): Epoch {
    return {
      genesisTime: object.genesis_time ?? new Date(0),
      epochDuration: object?.epoch_duration ? Duration.fromAmino(object.epoch_duration) : Duration.fromPartial({}),
      currentEpoch: BigInt(object.current_epoch),
      currentEpochStartTime: object.current_epoch_start_time ?? new Date(0),
