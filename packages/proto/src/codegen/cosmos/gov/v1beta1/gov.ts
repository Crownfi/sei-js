...
export const Proposal = {
  ...
  fromPartial(object: DeepPartial<Proposal>): Proposal {
    const message = createBaseProposal();
    message.proposalId = object.proposalId !== undefined && object.proposalId !== null ? BigInt(object.proposalId.toString()) : BigInt(0);
    message.content = Any.fromPartial(object.content ?? {}) as any;
    message.status = object.status ?? 0;
    message.finalTallyResult = TallyResult.fromPartial(object.finalTallyResult ?? {});
    message.submitTime = object.submitTime ?? new Date(0);
    message.depositEndTime = object.depositEndTime ?? new Date(0);
    message.totalDeposit = object.totalDeposit?.map(e => Coin.fromPartial(e)) || [];
    message.votingStartTime = object.votingStartTime ?? new Date(0);
    message.votingEndTime = object.votingEndTime ?? new Date(0);
    return message;
  },
  fromAmino(object: ProposalAmino): Proposal {
    return {
      proposalId: BigInt(object.proposal_id),
      content: object?.content ? Content_FromAmino(object.content) : (Any.fromPartial({}) as any),
      ...
      submitTime: object.submit_time ?? new Date(0),
      depositEndTime: object.deposit_end_time ?? new Date(0),
      totalDeposit: Array.isArray(object?.total_deposit) ? object.total_deposit.map((e: any) => Coin.fromAmino(e)) : [],
      votingStartTime: object.voting_start_time ?? new Date(0),
      votingEndTime: object.voting_end_time ?? new Date(0)
    };
  },
