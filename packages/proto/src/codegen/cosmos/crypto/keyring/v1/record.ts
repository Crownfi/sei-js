...
export const Record = {
  ...
  fromPartial(object: DeepPartial<Record>): Record {
    ...
    message.pubKey = Any.fromPartial(object.pubKey ?? {}) as any;
  ...
  fromAmino(object: RecordAmino): Record {
    return {
      name: object.name,
      pubKey: object?.pub_key ? Any.fromAmino(object.pub_key) : Any.fromPartial({}),
      local: object?.local ? Record_Local.fromAmino(object.local) : Record_Local.fromPartial({}),
      ledger: object?.ledger ? Record_Ledger.fromAmino(object.ledger) : Record_Ledger.fromPartial({}),
      multi: object?.multi ? Record_Multi.fromAmino(object.multi) : Record_Multi.fromPartial({}),
      offline: object?.offline ? Record_Offline.fromAmino(object.offline) : Record_Offline.fromPartial({})
    };
  },
...
export const Record_Local = {
  ...
  fromPartial(object: DeepPartial<Record_Local>): Record_Local {
    const message = createBaseRecord_Local();
    message.privKey = Any.fromPartial(object.privKey ?? {}) as any;
    message.privKeyType = object.privKeyType ?? "";
    return message;
  },
  fromAmino(object: Record_LocalAmino): Record_Local {
    return {
      privKey: object?.priv_key ? Any.fromAmino(object.priv_key) : Any.fromPartial({}),
...
export const Record_Ledger = {
  ...
  fromAmino(object: Record_LedgerAmino): Record_Ledger {
    return {
      path: object?.path ? BIP44Params.fromAmino(object.path) : BIP44Params.fromPartial({})
    };
  },
