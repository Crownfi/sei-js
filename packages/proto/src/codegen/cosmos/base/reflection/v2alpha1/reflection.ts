...
export const AppDescriptor = {
  ...
  fromAmino(object: AppDescriptorAmino): AppDescriptor {
    return {
      authn: object?.authn ? AuthnDescriptor.fromAmino(object.authn) : AuthnDescriptor.fromPartial({}),
      chain: object?.chain ? ChainDescriptor.fromAmino(object.chain) : ChainDescriptor.fromPartial({}),
      codec: object?.codec ? CodecDescriptor.fromAmino(object.codec) : CodecDescriptor.fromPartial({}),
      configuration: object?.configuration ? ConfigurationDescriptor.fromAmino(object.configuration) : ConfigurationDescriptor.fromPartial({}),
      queryServices: object?.query_services ? QueryServicesDescriptor.fromAmino(object.query_services) : QueryServicesDescriptor.fromPartial({}),
      tx: object?.tx ? TxDescriptor.fromAmino(object.tx) : TxDescriptor.fromPartial({})
    };
  },
...
export const GetConfigurationDescriptorResponse = {
  ...
  fromAmino(object: GetConfigurationDescriptorResponseAmino): GetConfigurationDescriptorResponse {
    return {
      config: object?.config ? ConfigurationDescriptor.fromAmino(object.config) : ConfigurationDescriptor.fromPartial({})
    };
  },
...
export const GetQueryServicesDescriptorResponse = {
  ...
  fromAmino(object: GetQueryServicesDescriptorResponseAmino): GetQueryServicesDescriptorResponse {
    return {
      queries: object?.queries ? QueryServicesDescriptor.fromAmino(object.queries) : QueryServicesDescriptor.fromPartial({})
    };
  },
