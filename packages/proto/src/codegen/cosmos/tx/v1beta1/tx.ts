...
import { SignMode, signModeFromJSON } from "../signing/v1beta1/signing.js";
...
export const Tx = {
  ...
  fromAmino(object: TxAmino): Tx {
    return {
      body: object?.body ? TxBody.fromAmino(object.body) : TxBody.fromPartial({}),
      authInfo: object?.auth_info ? AuthInfo.fromAmino(object.auth_info) : AuthInfo.fromPartial({}),
...
export const SignDocDirectAux = {
  ...
  fromAmino(object: SignDocDirectAuxAmino): SignDocDirectAux {
    return {
      ...
      tip: object?.tip ? Tip.fromAmino(object.tip) : Tip.fromPartial({})
    };
  },
...
export const SignerInfo = {
  ...
  fromAmino(object: SignerInfoAmino): SignerInfo {
    return {
      publicKey: object?.public_key ? Any.fromAmino(object.public_key) : Any.fromPartial({}),
      modeInfo: object?.mode_info ? ModeInfo.fromAmino(object.mode_info) : ModeInfo.fromPartial({}),
      sequence: BigInt(object.sequence)
    };
  },
...
export const ModeInfo = {
  ...
  fromAmino(object: ModeInfoAmino): ModeInfo {
    return {
      single: object?.single ? ModeInfo_Single.fromAmino(object.single) : ModeInfo_Single.fromPartial({}),
      multi: object?.multi ? ModeInfo_Multi.fromAmino(object.multi) : ModeInfo_Multi.fromPartial({})
    };
  },
...
export const ModeInfo_Multi = {
  ...
  fromAmino(object: ModeInfo_MultiAmino): ModeInfo_Multi {
    return {
      bitarray: object?.bitarray ? CompactBitArray.fromAmino(object.bitarray) : CompactBitArray.fromPartial({}),
...
export const AuxSignerData = {
  ...
  fromAmino(object: AuxSignerDataAmino): AuxSignerData {
    return {
      ...
      signDoc: object?.sign_doc ? SignDocDirectAux.fromAmino(object.sign_doc) : SignDocDirectAux.fromPartial({}),
      mode: isSet(object.mode) ? signModeFromJSON(object.mode) : -1,
      sig: object.sig
    };
  },
