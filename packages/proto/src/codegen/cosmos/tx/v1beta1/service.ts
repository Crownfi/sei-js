...
export const BroadcastTxResponse = {
  ...
  fromAmino(object: BroadcastTxResponseAmino): BroadcastTxResponse {
    return {
      txResponse: object?.tx_response ? TxResponse.fromAmino(object.tx_response) : TxResponse.fromPartial({})
    };
  },
...
export const SimulateRequest = {
  ...
  fromAmino(object: SimulateRequestAmino): SimulateRequest {
    return {
      tx: object?.tx ? Tx.fromAmino(object.tx) : Tx.fromPartial({}),
      txBytes: object.tx_bytes
    };
  },
...
export const SimulateResponse = {
  ...
  fromAmino(object: SimulateResponseAmino): SimulateResponse {
    return {
      ...
      result: object?.result ? Result.fromAmino(object.result) : Result.fromPartial({})
    };
  },
...
export const GetBlockWithTxsResponse = {
  ...
  fromAmino(object: GetBlockWithTxsResponseAmino): GetBlockWithTxsResponse {
    return {
      ...
      block: object?.block ? Block.fromAmino(object.block) : Block.fromPartial({}),
      pagination: object?.pagination ? PageResponse.fromAmino(object.pagination) : PageResponse.fromPartial({})
    };
  },
