...
export const SignatureDescriptor = {
  ...
  fromAmino(object: SignatureDescriptorAmino): SignatureDescriptor {
    return {
      ...
      data: object?.data ? SignatureDescriptor_Data.fromAmino(object.data) : SignatureDescriptor_Data.fromPartial({}),
...
export const SignatureDescriptor_Data = {
  ...
  fromAmino(object: SignatureDescriptor_DataAmino): SignatureDescriptor_Data {
    return {
      single: object?.single ? SignatureDescriptor_Data_Single.fromAmino(object.single) : SignatureDescriptor_Data_Single.fromPartial({}),
      multi: object?.multi ? SignatureDescriptor_Data_Multi.fromAmino(object.multi) : SignatureDescriptor_Data_Multi.fromPartial({})
    };
  },
