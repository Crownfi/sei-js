...
export const QueryDelegationResponse = {
  ...
  fromAmino(object: QueryDelegationResponseAmino): QueryDelegationResponse {
    return {
      delegationResponse: object?.delegation_response ? DelegationResponse.fromAmino(object.delegation_response) : DelegationResponse.fromPartial({})
    };
  },
...
export const QueryHistoricalInfoResponse = {
  ...
  fromAmino(object: QueryHistoricalInfoResponseAmino): QueryHistoricalInfoResponse {
    return {
      hist: object?.hist ? HistoricalInfo.fromAmino(object.hist) : HistoricalInfo.fromPartial({})
    };
  },
