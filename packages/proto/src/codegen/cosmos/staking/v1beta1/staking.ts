...
export const Commission = {
  ...
  fromPartial(object: DeepPartial<Commission>): Commission {
    ...
    message.updateTime = object.updateTime ?? new Date(0);
    return message;
  },
  fromAmino(object: CommissionAmino): Commission {
    return {
      ...
      updateTime: object.update_time ?? new Date(0)
    };
  },
...
export const Validator = {
  ...
  fromPartial(object: DeepPartial<Validator>): Validator {
    ...
    message.consensusPubkey = Any.fromPartial(object.consensusPubkey ?? {}) as any;
    ...
    message.unbondingTime = object.unbondingTime ?? new Date(0);
  ...
  fromAmino(object: ValidatorAmino): Validator {
    return {
      ...
      unbondingTime: object.unbonding_time ?? new Date(0),
...
export const UnbondingDelegationEntry = {
  ...
  fromPartial(object: DeepPartial<UnbondingDelegationEntry>): UnbondingDelegationEntry {
    ...
    message.completionTime = object.completionTime ?? new Date(0);
  ...
  fromAmino(object: UnbondingDelegationEntryAmino): UnbondingDelegationEntry {
    return {
      ...
      completionTime: object.completion_time ?? new Date(0),
