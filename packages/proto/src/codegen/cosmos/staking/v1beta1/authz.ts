...
export const StakeAuthorization = {
  ...
  fromAmino(object: StakeAuthorizationAmino): StakeAuthorization {
    return {
      maxTokens: object?.max_tokens ? Coin.fromAmino(object.max_tokens) : Coin.fromPartial({}),
      allowList: object?.allow_list ? StakeAuthorization_Validators.fromAmino(object.allow_list) : StakeAuthorization_Validators.fromPartial({}),
      denyList: object?.deny_list ? StakeAuthorization_Validators.fromAmino(object.deny_list) : StakeAuthorization_Validators.fromPartial({}),
