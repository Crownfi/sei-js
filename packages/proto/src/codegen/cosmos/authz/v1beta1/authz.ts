...
export const Grant = {
  ...
  fromPartial(object: DeepPartial<Grant>): Grant {
    const message = createBaseGrant();
    message.authorization = Any.fromPartial(object.authorization ?? {}) as any;
    message.expiration = object.expiration ?? undefined;
    return message;
  },
  fromAmino(object: GrantAmino): Grant {
    return {
      authorization: object?.authorization ? Authorization_FromAmino(object.authorization) : (Any.fromPartial({}) as any),
