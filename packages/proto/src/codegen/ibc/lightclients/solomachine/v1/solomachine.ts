...
import { ConnectionEnd, ConnectionEndAmino, ConnectionEndSDKType } from "../../../core/connection/v1/connection.js";
import { Channel, ChannelAmino, ChannelSDKType } from "../../../core/channel/v1/channel.js";
...
export const ClientState = {
  ...
  fromAmino(object: ClientStateAmino): ClientState {
    return {
      ...
      consensusState: object?.consensus_state ? ConsensusState.fromAmino(object.consensus_state) : ConsensusState.fromPartial({}),
...
export const ConsensusState = {
  ...
  fromPartial(object: DeepPartial<ConsensusState>): ConsensusState {
    const message = createBaseConsensusState();
    message.publicKey = Any.fromPartial(object.publicKey ?? {}) as any;
  ...
  fromAmino(object: ConsensusStateAmino): ConsensusState {
    return {
      publicKey: object?.public_key ? Any.fromAmino(object.public_key) : Any.fromPartial({}),
...
export const Header = {
  ...
  fromPartial(object: DeepPartial<Header>): Header {
    ...
    message.newPublicKey = Any.fromPartial(object.newPublicKey ?? {}) as any;
  ...
  fromAmino(object: HeaderAmino): Header {
    return {
      ...
      newPublicKey: object?.new_public_key ? Any.fromAmino(object.new_public_key) : Any.fromPartial({}),
...
export const Misbehaviour = {
  ...
  fromAmino(object: MisbehaviourAmino): Misbehaviour {
    return {
      ...
      sequence: BigInt(object.sequence),
      signatureOne: object?.signature_one ? SignatureAndData.fromAmino(object.signature_one) : SignatureAndData.fromPartial({}),
      signatureTwo: object?.signature_two ? SignatureAndData.fromAmino(object.signature_two) : SignatureAndData.fromPartial({})
    };
  },
...
export const HeaderData = {
  ...
  fromPartial(object: DeepPartial<HeaderData>): HeaderData {
    const message = createBaseHeaderData();
    message.newPubKey = Any.fromPartial(object.newPubKey ?? {}) as any;
    message.newDiversifier = object.newDiversifier ?? "";
    return message;
  },
  fromAmino(object: HeaderDataAmino): HeaderData {
    return {
      newPubKey: object?.new_pub_key ? Any.fromAmino(object.new_pub_key) : Any.fromPartial({}),
      newDiversifier: object.new_diversifier
    };
  },
...
export const ClientStateData = {
  ...
  fromPartial(object: DeepPartial<ClientStateData>): ClientStateData {
    ...
    message.clientState = Any.fromPartial(object.clientState ?? {}) as any;
    return message;
  },
  fromAmino(object: ClientStateDataAmino): ClientStateData {
    return {
      path: object.path,
      clientState: object?.client_state ? Any.fromAmino(object.client_state) : Any.fromPartial({})
    };
  },
...
export const ConsensusStateData = {
  ...
  fromPartial(object: DeepPartial<ConsensusStateData>): ConsensusStateData {
    const message = createBaseConsensusStateData();
    message.path = object.path ?? new Uint8Array();
    message.consensusState = Any.fromPartial(object.consensusState ?? {}) as any;
    return message;
  },
  fromAmino(object: ConsensusStateDataAmino): ConsensusStateData {
    return {
      path: object.path,
      consensusState: object?.consensus_state ? Any.fromAmino(object.consensus_state) : Any.fromPartial({})
    };
  },
...
export const ConnectionStateData = {
  ...
  fromAmino(object: ConnectionStateDataAmino): ConnectionStateData {
    return {
      path: object.path,
      connection: object?.connection ? ConnectionEnd.fromAmino(object.connection) : ConnectionEnd.fromPartial({})
    };
  },
