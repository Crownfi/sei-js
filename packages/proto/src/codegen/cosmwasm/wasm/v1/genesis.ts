import { MsgStoreCode, MsgStoreCodeAmino, MsgStoreCodeSDKType, MsgInstantiateContract, MsgInstantiateContractAmino, MsgInstantiateContractSDKType, MsgExecuteContract, MsgExecuteContractAmino, MsgExecuteContractSDKType } from "./tx.js";
import { Params, ParamsAmino, ParamsSDKType, CodeInfo, CodeInfoAmino, CodeInfoSDKType, ContractInfo, ContractInfoAmino, ContractInfoSDKType, Model, ModelAmino, ModelSDKType } from "./types.js";
...
export const GenesisState_GenMsgs = {
  ...
  fromAmino(object: GenesisState_GenMsgsAmino): GenesisState_GenMsgs {
    return {
      storeCode: object?.store_code ? MsgStoreCode.fromAmino(object.store_code) : MsgStoreCode.fromPartial({}),
      instantiateContract: object?.instantiate_contract ? MsgInstantiateContract.fromAmino(object.instantiate_contract) : MsgInstantiateContract.fromPartial({}),
      executeContract: object?.execute_contract ? MsgExecuteContract.fromAmino(object.execute_contract) : MsgExecuteContract.fromPartial({})
    };
  },
