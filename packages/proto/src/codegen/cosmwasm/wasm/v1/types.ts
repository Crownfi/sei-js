...
export const ContractInfo = {
  ...
  fromPartial(object: DeepPartial<ContractInfo>): ContractInfo {
    ...
    message.extension = Any.fromPartial(object.extension ?? {}) as any;
    return message;
  },
  fromAmino(object: ContractInfoAmino): ContractInfo {
    return {
      ...
      admin: object.admin,
      label: object.label,
      created: object?.created ? AbsoluteTxPosition.fromAmino(object.created) : AbsoluteTxPosition.fromPartial({}),
      ibcPortId: object.ibc_port_id,
      extension: object?.extension ? ContractInfoExtension_FromAmino(object.extension) : (Any.fromPartial({}) as any)
    };
  },
...
export const ContractCodeHistoryEntry = {
  ...
  fromAmino(object: ContractCodeHistoryEntryAmino): ContractCodeHistoryEntry {
    return {
      ...
      codeId: BigInt(object.code_id),
      updated: object?.updated ? AbsoluteTxPosition.fromAmino(object.updated) : AbsoluteTxPosition.fromPartial({}),
