...
import { DeepPartial, toTimestamp, fromTimestamp, isSet } from "../../helpers.js";
...
export const Request = {
  ...
  fromAmino(object: RequestAmino): Request {
    return {
      echo: object?.echo ? RequestEcho.fromAmino(object.echo) : RequestEcho.fromPartial({}),
      flush: object?.flush ? RequestFlush.fromAmino(object.flush) : RequestFlush.fromPartial({}),
      info: object?.info ? RequestInfo.fromAmino(object.info) : RequestInfo.fromPartial({}),
      setOption: object?.set_option ? RequestSetOption.fromAmino(object.set_option) : RequestSetOption.fromPartial({}),
      initChain: object?.init_chain ? RequestInitChain.fromAmino(object.init_chain) : RequestInitChain.fromPartial({}),
      query: object?.query ? RequestQuery.fromAmino(object.query) : RequestQuery.fromPartial({}),
      beginBlock: object?.begin_block ? RequestBeginBlock.fromAmino(object.begin_block) : RequestBeginBlock.fromPartial({}),
      checkTx: object?.check_tx ? RequestCheckTx.fromAmino(object.check_tx) : RequestCheckTx.fromPartial({}),
      deliverTx: object?.deliver_tx ? RequestDeliverTx.fromAmino(object.deliver_tx) : RequestDeliverTx.fromPartial({}),
      endBlock: object?.end_block ? RequestEndBlock.fromAmino(object.end_block) : RequestEndBlock.fromPartial({}),
      commit: object?.commit ? RequestCommit.fromAmino(object.commit) : RequestCommit.fromPartial({}),
      listSnapshots: object?.list_snapshots ? RequestListSnapshots.fromAmino(object.list_snapshots) : RequestListSnapshots.fromPartial({}),
      offerSnapshot: object?.offer_snapshot ? RequestOfferSnapshot.fromAmino(object.offer_snapshot) : RequestOfferSnapshot.fromPartial({}),
      loadSnapshotChunk: object?.load_snapshot_chunk ? RequestLoadSnapshotChunk.fromAmino(object.load_snapshot_chunk) : RequestLoadSnapshotChunk.fromPartial({}),
      applySnapshotChunk: object?.apply_snapshot_chunk ? RequestApplySnapshotChunk.fromAmino(object.apply_snapshot_chunk) : RequestApplySnapshotChunk.fromPartial({})
    };
  },
...
export const RequestInitChain = {
  ...
  fromPartial(object: DeepPartial<RequestInitChain>): RequestInitChain {
    const message = createBaseRequestInitChain();
    message.time = object.time ?? new Date(0);
  ...
  fromAmino(object: RequestInitChainAmino): RequestInitChain {
    return {
      time: object.time ?? new Date(0),
      chainId: object.chain_id,
      consensusParams: object?.consensus_params ? ConsensusParams.fromAmino(object.consensus_params) : ConsensusParams.fromPartial({}),
...
export const RequestOfferSnapshot = {
  ...
  fromAmino(object: RequestOfferSnapshotAmino): RequestOfferSnapshot {
    return {
      snapshot: object?.snapshot ? Snapshot.fromAmino(object.snapshot) : Snapshot.fromPartial({}),
...
export const Response = {
  ...
  fromAmino(object: ResponseAmino): Response {
    return {
      exception: object?.exception ? ResponseException.fromAmino(object.exception) : ResponseException.fromPartial({}),
      echo: object?.echo ? ResponseEcho.fromAmino(object.echo) : ResponseEcho.fromPartial({}),
      flush: object?.flush ? ResponseFlush.fromAmino(object.flush) : ResponseFlush.fromPartial({}),
      info: object?.info ? ResponseInfo.fromAmino(object.info) : ResponseInfo.fromPartial({}),
      setOption: object?.set_option ? ResponseSetOption.fromAmino(object.set_option) : ResponseSetOption.fromPartial({}),
      initChain: object?.init_chain ? ResponseInitChain.fromAmino(object.init_chain) : ResponseInitChain.fromPartial({}),
      query: object?.query ? ResponseQuery.fromAmino(object.query) : ResponseQuery.fromPartial({}),
      beginBlock: object?.begin_block ? ResponseBeginBlock.fromAmino(object.begin_block) : ResponseBeginBlock.fromPartial({}),
      checkTx: object?.check_tx ? ResponseCheckTx.fromAmino(object.check_tx) : ResponseCheckTx.fromPartial({}),
      deliverTx: object?.deliver_tx ? ResponseDeliverTx.fromAmino(object.deliver_tx) : ResponseDeliverTx.fromPartial({}),
      endBlock: object?.end_block ? ResponseEndBlock.fromAmino(object.end_block) : ResponseEndBlock.fromPartial({}),
      commit: object?.commit ? ResponseCommit.fromAmino(object.commit) : ResponseCommit.fromPartial({}),
      listSnapshots: object?.list_snapshots ? ResponseListSnapshots.fromAmino(object.list_snapshots) : ResponseListSnapshots.fromPartial({}),
      offerSnapshot: object?.offer_snapshot ? ResponseOfferSnapshot.fromAmino(object.offer_snapshot) : ResponseOfferSnapshot.fromPartial({}),
      loadSnapshotChunk: object?.load_snapshot_chunk ? ResponseLoadSnapshotChunk.fromAmino(object.load_snapshot_chunk) : ResponseLoadSnapshotChunk.fromPartial({}),
      applySnapshotChunk: object?.apply_snapshot_chunk ? ResponseApplySnapshotChunk.fromAmino(object.apply_snapshot_chunk) : ResponseApplySnapshotChunk.fromPartial({})
    };
  },
...
export const ResponseQuery = {
  ...
  fromAmino(object: ResponseQueryAmino): ResponseQuery {
    return {
      ...
      key: object.key,
      value: object.value,
      proofOps: object?.proof_ops ? ProofOps.fromAmino(object.proof_ops) : ProofOps.fromPartial({}),
      height: BigInt(object.height),
...
export const ResponseEndBlock = {
  ...
  fromAmino(object: ResponseEndBlockAmino): ResponseEndBlock {
    return {
      ...
      consensusParamUpdates: object?.consensus_param_updates ? ConsensusParams.fromAmino(object.consensus_param_updates) : ConsensusParams.fromPartial({}),
      events: Array.isArray(object?.events) ? object.events.map((e: any) => Event.fromAmino(e)) : []
    };
  },
