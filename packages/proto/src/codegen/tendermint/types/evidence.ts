...
export const Evidence = {
  ...
  fromAmino(object: EvidenceAmino): Evidence {
    return {
      duplicateVoteEvidence: object?.duplicate_vote_evidence ? DuplicateVoteEvidence.fromAmino(object.duplicate_vote_evidence) : DuplicateVoteEvidence.fromPartial({}),
      lightClientAttackEvidence: object?.light_client_attack_evidence ? LightClientAttackEvidence.fromAmino(object.light_client_attack_evidence) : LightClientAttackEvidence.fromPartial({})
    };
  },
...
export const DuplicateVoteEvidence = {
  ...
  fromAmino(object: DuplicateVoteEvidenceAmino): DuplicateVoteEvidence {
    return {
      voteA: object?.vote_a ? Vote.fromAmino(object.vote_a) : Vote.fromPartial({}),
      voteB: object?.vote_b ? Vote.fromAmino(object.vote_b) : Vote.fromPartial({}),
...
export const LightClientAttackEvidence = {
  ...
  fromAmino(object: LightClientAttackEvidenceAmino): LightClientAttackEvidence {
    return {
      conflictingBlock: object?.conflicting_block ? LightBlock.fromAmino(object.conflicting_block) : LightBlock.fromPartial({}),
